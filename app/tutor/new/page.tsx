...
export default async function NewQuizPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden animate-in fade-in duration-500">
      {/* Top bar */}
      <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-md border-b border-border/40">
        <div className="max-w-3xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
          ...
          <span className="inline-flex items-center gap-2 text-xs font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
      ...
      <main className="max-w-3xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="text-center space-y-4 mb-12">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-primary/25 to-primary/5 border border-primary/30 flex items-center justify-center shadow-inner">
            <Sparkles className="w-8 h-8 text-primary" />
          </div>
          <h1 className="text-4xl md:text-6xl font-heading font-bold tracking-tighter">Generate a New Quiz</h1>
